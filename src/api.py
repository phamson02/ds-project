...
def main(args):
    # url = 'https://9bdd-128-199-214-29.ngrok-free.app/api/'
    # Use environment variable to store url instead of hardcoding it here
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--type", type=str, required=True, help="Type of data to insert"
    )
